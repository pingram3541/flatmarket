...
final class WP_Installer{
    ...
    public function append_parameters_to_buy_url($url, $args = array()){
        ...
        $url = esc_url(add_query_arg( array('icl_site_url' => $this->get_installer_site_url() ), $url ));
        ...
        if($affiliate_id && $affiliate_key){
            $url = esc_url(add_query_arg(array('affiliate_id' => $affiliate_id, 'affiliate_key' => $affiliate_key), $url));
        }
    ...
    public function append_site_key_to_download_url($url, $key, $repository_id){
        ...
        $url = esc_url(add_query_arg(array('site_key' => $key, 'site_url' => $this->get_installer_site_url($repository_id) ), $url));
