                    ...
                    <table class="installer-plugins-list-compact">
                        <thead>
                            <tr>
                                ...
                                <th><img src="<?php echo get_template_directory_uri(); ?>/inc/wpml-installer/res/img/globe.png" alt="<?php esc_attr_e('Available', 'installer') ?>" width="16" height="16"></th>
                                <th><img src="<?php echo get_template_directory_uri(); ?>/inc/wpml-installer/res/img/computer.png" alt="<?php esc_attr_e('Installed', 'installer') ?>" width="16" height="16"></th>
                                <th><img src="<?php echo get_template_directory_uri(); ?>/inc/wpml-installer/res/img/dn2.gif" alt="<?php esc_attr_e('Downloading', 'installer') ?>" width="16" height="16"></th>
                                <th><img src="<?php echo get_template_directory_uri(); ?>/inc/wpml-installer/res/img/on.png" alt="<?php esc_attr_e('Activate', 'installer') ?>" width="16" height="16"></th>
                            </tr>
                        </thead>                        
                        <tbody>
                    ...
                    <div class="ipanel-info alert" style="margin-top: 10px;">If plugins does not download/activate correctly check that you added your site url for key correctly on WPML site exactly as it appeared in your <a target="blank" href="options-general.php">Settings</a> page (<b>with or without trailing slash</b>, this is very important).</div>
